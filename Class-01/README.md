...
3. EC2 :
   ...
   -- Key Components of EC2 -:
     ...
     5. Security groups (SG) - this manages the ports that allows traffic to and from your instance, its like a door for an instance and the range of these ports varies between 0-65535.
